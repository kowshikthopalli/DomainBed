...
class MultipleEnvironmentCIFAR(MultipleDomainDataset):
    def __init__(self, root, environments, dataset_transform, input_shape,
        ...
        for i in range(len(environments)-1):
            ...
            self.datasets.append(torch.utils.data.Subset(original_dataset_tr, total_indices_all[i])) # 12500 *4

        # append the test set
        self.datasets.append(original_dataset_te) #10000
